...
<html>
    ...
    <body>
        ...
        <br><br>
        <br><br>
    <center><h3>The Percentage of Expenditure as Gifts</h3>
       <%!
        ...
        <%
            try {
                ...
                PreparedStatement p = conn.prepareStatement("SELECT `BwdELCA`,`TDELCa-L` FROM result8");
...
//            double[] data1 = {50, 55, 47, 34, 47, 53, 38, 40, 51};
        ...
        // Add a title to the x axis using CMDL
            c.xAxis().setTitle(" Percentage of Expenditure as Gifts");
