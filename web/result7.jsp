...
<html>
    ...
    <body>
        ...
        <br><br>
        <br><br>
        <center><h3>Total Percentage of Expenditure from Banks</h3>
       <%!
        ...
        <%
            try {
                ...
                PreparedStatement p = conn.prepareStatement("SELECT `BwdELCA`,`TDELCa-L` FROM result7");
...
//            double[] data1 = {50, 55, 47, 34, 47, 53, 38, 40, 51};
        ...
        // Add a title to the x axis using CMDL
            c.xAxis().setTitle(" Percentage of Expenditure from Banks");
