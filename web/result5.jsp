<%-- 
    Document   : result1
    Created on : Sep 19, 2017, 12:36:24 PM
    Author     : sai
--%>
...
<html>
    ...
    <body>
        ...
        <br><br>
        <br><br>
    <center><h3>Number of Services Purchased  by an Account</h3>
       <%!
        ...
        <%
            try {
                ...
                PreparedStatement p = conn.prepareStatement("SELECT `BwdELCA`,`TDELCa-L` FROM result5");
...
//            double[] data1 = {50, 55, 47, 34, 47, 53, 38, 40, 51};
        ...
        // Add a title to the x axis using CMDL
            c.xAxis().setTitle("Ratio Number of Services Purchased  by an Account");
