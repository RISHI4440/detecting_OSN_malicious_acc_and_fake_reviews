...
<html>
    ...
    <body>
        ...
        <form action="final_intimation.jsp" method="post">       
            <div class="content">
                <div class="content_bottom">
                    ...
                    <div class="feature_list">
                        ...
                        <table style="margin-left: 3%;height: 50%;width: 70%">
                            ...
                            <%
                                ...
                                if (a.equals("2")) {
                                    ...
                                    response.sendRedirect("shopping.jsp?product=" + a);
                                }
                                if (a.equals("6")) {
                                ...
                                PreparedStatement p = conn.prepareStatement("select id,name,price from image1 where id=?");
                                p.setString(1, a);
                        ...
                        <hr>
                        <h1 style="margin-left: 1%">Total  Price</h1>
