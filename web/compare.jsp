         ...
         <div class="content">
                <div class="content_bottom">
                    ...
                    <div class="feature_list">
                        ...
                        <form id="UploadForm" action="comparing.jsp" method="get">
                            <table style="margin-left: 30%;margin-top: 15%;height: 50%">
                                <!--                    <td><img src="images/images.jpg" style="margin-left: 25%;margin-top:-45%"></td>-->
                                <td><img src="img/comparing.jpg" style="margin-left: 25%;margin-top:-45%;height: 150%"></td>
                                <tr><td><input type="file" size="60" id="myfile" name="myfile" multiple="true"/></td> 
