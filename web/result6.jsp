...
<html>
    ...
    <body>
        ...
        <br><br>
        <br><br>
    <center><h3>Total ammount of Expenditure</h3>
       <%!
        ...
        <%
            try {
                ...
                PreparedStatement p = conn.prepareStatement("SELECT `BwdELCA`,`TDELCa-L` FROM result6");
...
//            double[] data1 = {50, 55, 47, 34, 47, 53, 38, 40, 51};
        ...
        // Add a title to the x axis using CMDL
            c.xAxis().setTitle("Total ammount of Expenditure");
