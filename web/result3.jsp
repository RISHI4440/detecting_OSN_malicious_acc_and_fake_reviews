...
<!DOCTYPE html>
    ...
    <head>
        ...
        <br><br>
        <br><br>
    <center><h3>Ratio The average recharge amount</h3>
                <%!
        ...
        <%
            try {
                ...
                PreparedStatement p = conn.prepareStatement("SELECT `BwdELCA`,`TDELCa-L` FROM result3");
...
//            double[] data1 = {50, 55, 47, 34, 47, 53, 38, 40, 51};
        ...
        // Add a title to the x axis using CMDL
            c.xAxis().setTitle(" The average recharge amount.");
